            ...
            <?php foreach ($new_musics as $music): ?>
                ...
                <div class="album">
                    ...
                    <div class="album__title">
                        <h3><a href="release.html"><?= $music->name ?></a></h3>
                    ...
                    <div class="col-12">
                        <ul class="main__list">
                            <?php foreach ($top_musics as $i => $music): ?>
                                ...
                                <a data-link data-title="<?= $music->name ?>" data-artist="<?= $music->name ?>" data-img="<?= $music->banner ?>" href="<?= $music->music_path ?>" class="single-item__cover">
                                    <img src="<?= $music->banner ?>" alt="">
                                ...
                                <div class="single-item__title">
                                    <h4><a href="#"><?= $music->name ?></a></h4>
                                    <span><a href="artist.html"><?= $music->singer ?></a></span>
                                </div>
