                    ...
                    <div class="release__list">
                        <ul class="main__list main__list--playlist main__list--dashbox">
                            <?php foreach ($musics as $i => $music): ?>
                                ...
                                <a <?= $no === 1 ? 'id="first-song"' : '' ?> data-playlist data-title="<?= "$no .$music->name" ?>" data-artist="<?= $music->singer ?>" data-img="<?= $music->banner ?>" href="<?= $music->bannerPath ?>" class="single-item__cover">
                                ...
                                <button data-url="<?= $music->music_path ?>" class="btn-download single-item__export">
